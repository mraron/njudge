...
export function SVGLock({ cls }) {
    return (
        <svg className={`${cls} fill-current`} viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
export function SVGSpinner({ cls }) {
    return (
        <svg className={`${cls} text-grey-700 animate-spin fill-indigo-600`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
