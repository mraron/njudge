            ...
            <form method="POST">
                <div className="px-10 py-8">
                    ...
                    <div className="flex justify-center mb-2">
                        <button type="submit" className="btn-indigo padding-btn-default mr-2 w-1/2"
                                onClick={handleLogin}>
                            {t("login.login")}
                        </button>
                        <button
                            className="relative btn-gray padding-btn-default flex items-center justify-between w-1/2">
