...
import { SVGLock, SVGSettings } from "../../components/svg/SVGs";
        ...
        <RoundedFrame titleComponent={titleComponent}>
            <div className="flex flex-col px-6 py-5 sm:px-10 sm:py-8 w-full">
                ...
                <div className="flex justify-center">
                    <button
                        className="btn-indigo padding-btn-default w-32"
...
function OtherSettingsFrame({ data }) {
    ...
    const titleComponent = (
        <SVGTitleComponent
            svg={<SVGSettings cls="w-5 h-5 mr-2" />}
