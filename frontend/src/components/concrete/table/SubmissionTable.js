    ...
    return (
        <tr>
            {index === 0 && (
                <>
                    <td
                        className={`padding-td-default border border-t-0 border-divide-col text-center ${bottomBorderGroup}`}
                        rowSpan={numCases}>
            ...
            {group.scoring === 1 && (
                <>
                    ...
                    <td
                        className={`padding-td-default border border-t-0 border-divide-col whitespace-nowrap ${bottomBorderCase}`}>
            ...
            <td
                className={`padding-td-default border border-t-0 border-r-0 border-divide-col ${bottomBorderCase}`}>
                {testCase.memoryUsed}
            </td>
        </tr>
    );
