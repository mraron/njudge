...
function DropdownList({ tree }) {
    ...
    const leafNode = 
        <a className="w-fit flex items-center cursor-pointer hover:text-indigo-300 transition-all duration-100" onMouseOver={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
            {arrow}{tree["title"]}
        </a>
