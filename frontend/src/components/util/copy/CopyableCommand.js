...
function CopyableCommand({ text, cls }) {
    return (
        <RoundedFrame cls={`${cls} overflow-auto`}>
            <div className="p-1 relative bg-codebgcol flex">
                <div className="flex items-center w-full px-4 py-3 overflow-x-auto whitespace-nowrap font-code">
                    {text}
                </div>
                <div className="absolute right-2 top-1/2 transform -translate-y-1/2 opacity-75 hover:opacity-100 transition-opacity duration-200">
