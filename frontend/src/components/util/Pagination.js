...
function Pagination({ paginationData }) {
    ...
    const cls = "flex justify-center items-center px-3 py-1.5 text-sm border-border-str border hover:bg-grey-775"
    return (
        <RoundedFrame cls="overflow-hidden">
            <div className="flex justify-center p-4 overflow-x-auto">
                ...
                <button className="px-3 py-1.5 text-sm bg-button border border-border-str text-center">
                    {currentPage}
                </button>
