...
var (
	problemRelDBTypes = map[string]string{`ID`: `integer`, `Problem`: `text`, `Problemset`: `text`}
	_                 = bytes.MinRead
)
...
func testProblemRelsUpdate(t *testing.T) {
	...
	if len(problemRelColumns) == len(problemRelPrimaryKeyColumns) {
...
func testProblemRelsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(problemRelColumns, problemRelPrimaryKeyColumns) {
		fields = problemRelColumns
	} else {
