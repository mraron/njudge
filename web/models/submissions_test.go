...
func testSubmissionsUpdate(t *testing.T) {
	...
	if len(submissionColumns) == len(submissionPrimaryKeyColumns) {
...
func testSubmissionsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(submissionColumns, submissionPrimaryKeyColumns) {
		fields = submissionColumns
	} else {
