...
var (
	judgeColumns               = []string{"id", "state", "host", "port", "ping", "online"}
...
type (
	...
	// This should generally be used opposed to []Judge.
	JudgeSlice []*Judge
...
func (o JudgeSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Judge slice provided for delete all")
	}
