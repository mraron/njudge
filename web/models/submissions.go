...
var (
	submissionColumns               = []string{"id", "status", "ontest", "user_id", "problemset", "problem", "language", "private", "verdict", "source", "started", "submitted", "judged"}
...
func (o SubmissionSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Submission slice provided for delete all")
	}
