...
var judgeAfterSelectMu sync.Mutex
var judgeAfterSelectHooks []JudgeHook

var judgeBeforeInsertMu sync.Mutex
var judgeBeforeInsertHooks []JudgeHook
var judgeAfterInsertMu sync.Mutex
var judgeAfterInsertHooks []JudgeHook

var judgeBeforeUpdateMu sync.Mutex
var judgeBeforeUpdateHooks []JudgeHook
var judgeAfterUpdateMu sync.Mutex
var judgeAfterUpdateHooks []JudgeHook

var judgeBeforeDeleteMu sync.Mutex
var judgeBeforeDeleteHooks []JudgeHook
var judgeAfterDeleteMu sync.Mutex
var judgeAfterDeleteHooks []JudgeHook

var judgeBeforeUpsertMu sync.Mutex
var judgeBeforeUpsertHooks []JudgeHook
var judgeAfterUpsertMu sync.Mutex
...
func (o *Judge) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *Judge) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(judgeAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(judgePrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert judges, could not build conflict column list")
			}

			conflict = make([]string, len(judgePrimaryKeyColumns))
			copy(conflict, judgePrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"judges\"", updateOnConflict, ret, update, conflict, insert, opts...)
