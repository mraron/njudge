...
func (o *User) ProblemTags(mods ...qm.QueryMod) problemTagQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"problem_tags\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadForgottenPasswordKey(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`forgotten_password_keys`),
		qm.WhereIn(`forgotten_password_keys.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadProblemTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`problem_tags.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
