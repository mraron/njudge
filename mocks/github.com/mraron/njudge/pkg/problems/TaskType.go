...
func (_m *TaskType) Compile(_a0 problems.EvaluationInfo, _a1 sandbox.Sandbox, _a2 language.Language, _a3 io.Reader, _a4 io.Writer) (io.Reader, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)

	var r0 io.Reader
	var r1 error
	if rf, ok := ret.Get(0).(func(problems.EvaluationInfo, sandbox.Sandbox, language.Language, io.Reader, io.Writer) (io.Reader, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4)
	}
	if rf, ok := ret.Get(0).(func(problems.EvaluationInfo, sandbox.Sandbox, language.Language, io.Reader, io.Writer) io.Reader); ok {
	...
	if rf, ok := ret.Get(1).(func(problems.EvaluationInfo, sandbox.Sandbox, language.Language, io.Reader, io.Writer) error); ok {
...
func (_c *TaskType_Compile_Call) Run(run func(_a0 problems.EvaluationInfo, _a1 sandbox.Sandbox, _a2 language.Language, _a3 io.Reader, _a4 io.Writer)) *TaskType_Compile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(problems.EvaluationInfo), args[1].(sandbox.Sandbox), args[2].(language.Language), args[3].(io.Reader), args[4].(io.Writer))
	})
	return _c
}
...
func (_c *TaskType_Compile_Call) RunAndReturn(run func(problems.EvaluationInfo, sandbox.Sandbox, language.Language, io.Reader, io.Writer) (io.Reader, error)) *TaskType_Compile_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *TaskType) Run(_a0 problems.EvaluationInfo, _a1 *sandbox.ChanProvider, _a2 language.Language, _a3 io.Reader, _a4 chan string, _a5 chan problems.Status) (problems.Status, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5)

	var r0 problems.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(problems.EvaluationInfo, *sandbox.ChanProvider, language.Language, io.Reader, chan string, chan problems.Status) (problems.Status, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4, _a5)
	}
	if rf, ok := ret.Get(0).(func(problems.EvaluationInfo, *sandbox.ChanProvider, language.Language, io.Reader, chan string, chan problems.Status) problems.Status); ok {
		r0 = rf(_a0, _a1, _a2, _a3, _a4, _a5)
	} else {
		r0 = ret.Get(0).(problems.Status)
	}

	if rf, ok := ret.Get(1).(func(problems.EvaluationInfo, *sandbox.ChanProvider, language.Language, io.Reader, chan string, chan problems.Status) error); ok {
...
func (_c *TaskType_Run_Call) Run(run func(_a0 problems.EvaluationInfo, _a1 *sandbox.ChanProvider, _a2 language.Language, _a3 io.Reader, _a4 chan string, _a5 chan problems.Status)) *TaskType_Run_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(problems.EvaluationInfo), args[1].(*sandbox.ChanProvider), args[2].(language.Language), args[3].(io.Reader), args[4].(chan string), args[5].(chan problems.Status))
	})
	return _c
}
...
func (_c *TaskType_Run_Call) RunAndReturn(run func(problems.EvaluationInfo, *sandbox.ChanProvider, language.Language, io.Reader, chan string, chan problems.Status) (problems.Status, error)) *TaskType_Run_Call {
	_c.Call.Return(run)
	return _c
}
